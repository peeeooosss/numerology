...
export function Hero() {
  return <section id="top" className="relative overflow-hidden bg-cosmic-field px-5 pb-24 pt-36 sm:px-8 md:pb-32 md:pt-48">
    ...
    <div className="relative mx-auto max-w-4xl text-center">
      <p className="mb-6 inline-flex items-center gap-2 rounded-full border border-gold/30 px-4 py-1.5 text-xs uppercase tracking-[.2em] text-goldlite"><Sparkles className="h-3.5 w-3.5 text-gold" />Personalized numerology guidance</p>
      <h1 className="font-display text-4xl font-semibold leading-[1.08] text-cream sm:text-5xl md:text-7xl">Discover the <em className="bg-gradient-to-r from-gold via-goldlite to-copper bg-clip-text text-transparent">power</em> of your numbers.</h1>
