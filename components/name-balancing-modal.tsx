...
export function NameBalancingModal() {
  ...
  return <>
    ...
    {open && <div role="dialog" aria-modal="true" aria-labelledby="name-balancing-title" className="fixed inset-0 z-50 flex items-center justify-center bg-midnight/85 p-4 backdrop-blur-sm" onMouseDown={(event) => { if (event.target === event.currentTarget) setOpen(false); }}>
